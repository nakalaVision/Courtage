    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Emploi Add</h3>
            </div>
            <?php echo form_open('emploi/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="libelleEmploi" value="<?php echo $this->input->post('libelleEmploi'); ?>" class="form-control" id="libelleEmploi" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="typeEmploi" value="<?php echo $this->input->post('typeEmploi'); ?>" class="form-control" id="typeEmploi" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="contrat" value="<?php echo $this->input->post('contrat'); ?>" class="form-control" id="contrat" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="salaire" value="<?php echo $this->input->post('salaire'); ?>" class="form-control" id="salaire" />
						</div>
					</div>
				</div>
			</div>
