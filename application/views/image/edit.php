<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('image/edit/'.$image['idImages']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="idAnnonces" class="form-control">
								...
								{
									$selected = ($annonce['idannonces'] == $image['idAnnonces']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="url" value="<?php echo ($this->input->post('url') ? $this->input->post('url') : $image['url']); ?>" class="form-control" id="url" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="datecreation" value="<?php echo ($this->input->post('datecreation') ? $this->input->post('datecreation') : $image['datecreation']); ?>" class="has-datepicker form-control" id="datecreation" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="groupeRepertoire" value="<?php echo ($this->input->post('groupeRepertoire') ? $this->input->post('groupeRepertoire') : $image['groupeRepertoire']); ?>" class="form-control" id="groupeRepertoire" />
