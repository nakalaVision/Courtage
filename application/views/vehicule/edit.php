    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Vehicule Edit</h3>
            </div>
			<?php echo form_open('vehicule/edit/'.$vehicule['idVehicules']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="idCategories" class="form-control">
								...
								{
									$selected = ($category['idCategories'] == $vehicule['idCategories']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="libelleVehicule" value="<?php echo ($this->input->post('libelleVehicule') ? $this->input->post('libelleVehicule') : $vehicule['libelleVehicule']); ?>" class="form-control" id="libelleVehicule" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="marque" value="<?php echo ($this->input->post('marque') ? $this->input->post('marque') : $vehicule['marque']); ?>" class="form-control" id="marque" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="modele" value="<?php echo ($this->input->post('modele') ? $this->input->post('modele') : $vehicule['modele']); ?>" class="form-control" id="modele" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="datecirculation" value="<?php echo ($this->input->post('datecirculation') ? $this->input->post('datecirculation') : $vehicule['datecirculation']); ?>" class="has-datepicker form-control" id="datecirculation" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="kilometrage" value="<?php echo ($this->input->post('kilometrage') ? $this->input->post('kilometrage') : $vehicule['kilometrage']); ?>" class="form-control" id="kilometrage" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="energie" value="<?php echo ($this->input->post('energie') ? $this->input->post('energie') : $vehicule['energie']); ?>" class="form-control" id="energie" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="boiteVitesse" value="<?php echo ($this->input->post('boiteVitesse') ? $this->input->post('boiteVitesse') : $vehicule['boiteVitesse']); ?>" class="form-control" id="boiteVitesse" />
