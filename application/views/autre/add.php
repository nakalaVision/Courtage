    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Autre Add</h3>
            </div>
            <?php echo form_open('autre/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="libelleAutre" value="<?php echo $this->input->post('libelleAutre'); ?>" class="form-control" id="libelleAutre" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="typeAutre" value="<?php echo $this->input->post('typeAutre'); ?>" class="form-control" id="typeAutre" />
