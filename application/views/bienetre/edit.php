    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Bienetre Edit</h3>
            </div>
			<?php echo form_open('bienetre/edit/'.$bienetre['idBienEtre']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="idCategories" class="form-control">
								...
								{
									$selected = ($category['idCategories'] == $bienetre['idCategories']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="libelleBienEtre" value="<?php echo ($this->input->post('libelleBienEtre') ? $this->input->post('libelleBienEtre') : $bienetre['libelleBienEtre']); ?>" class="form-control" id="libelleBienEtre" />
